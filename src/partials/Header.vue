      ...
      <VBotCallButtons />
        ...
        <div class="flex items-center space-x-3">          
          <div class="flex items-center flex-row">
            <button
              class="w-8 h-8 mr-2 flex items-center justify-center hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800 rounded-full ml-3"
